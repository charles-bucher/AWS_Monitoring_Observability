...
⚡ **Project Overview**  
This repository contains the aws_monitoring_observability project. All resources and scripts were built for learning, demonstration, and personal experimentation. Screenshots or examples may have been created, but this project is **not a live site**.
...
- Repository: [GitHub](https://github.com/charles-bucher/aws_monitoring_observability)
